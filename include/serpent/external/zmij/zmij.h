...
#ifndef SERPENT_ZMIJ_H_
#define SERPENT_ZMIJ_H_
...
#ifdef _MSVC_LANG
#  define SERPENT_ZMIJ_CPLUSPLUS _MSVC_LANG
#else
#  define SERPENT_ZMIJ_CPLUSPLUS __cplusplus
#endif

#if SERPENT_ZMIJ_CPLUSPLUS >= 202002L
...
#  define SERPENT_ZMIJ_CONSTEXPR20 constexpr
#else
#  define SERPENT_ZMIJ_CONSTEXPR20
#endif

// Disabling C++14 relaxed constexpr costs ~2x, so it is opt-in, not detected.
#ifndef SERPENT_ZMIJ_USE_CONSTEXPR
#  define SERPENT_ZMIJ_USE_CONSTEXPR 1
#endif
#if SERPENT_ZMIJ_USE_CONSTEXPR
#  define SERPENT_ZMIJ_CONSTEXPR constexpr
#  define SERPENT_ZMIJ_DEFAULT(...) = __VA_ARGS__
#else
#  define SERPENT_ZMIJ_CONSTEXPR
// A default member initializer makes its class a non-aggregate in C++11.
#  define SERPENT_ZMIJ_DEFAULT(...)
#endif
...
#ifdef SERPENT_ZMIJ_USE_INT128
// Use the provided definition.
#elif defined(__SIZEOF_INT128__)
#  define SERPENT_ZMIJ_USE_INT128 1
#else
#  define SERPENT_ZMIJ_USE_INT128 0
#endif
...
#endif  // SERPENT_ZMIJ_USE_INT128

// Computes 128-bit result of multiplication of two 64-bit unsigned integers.
inline SERPENT_ZMIJ_CONSTEXPR auto umul128(uint64_t x, uint64_t y) noexcept
    -> uint128_t {
#if SERPENT_ZMIJ_USE_INT128
...
inline SERPENT_ZMIJ_CONSTEXPR auto umul192_hi128(uint64_t x_hi, uint64_t x_lo,
...
template <typename Float> struct float_traits : std::numeric_limits<Float> {
  ...
  static SERPENT_ZMIJ_CONSTEXPR20 auto to_bits(Float value) noexcept -> sig_type {
...
// Dougall Johnson.
inline SERPENT_ZMIJ_CONSTEXPR auto compute_pow10(int exp) noexcept -> uint128 {
...
inline SERPENT_ZMIJ_CONSTEXPR auto compute_exp_shift(int bin_exp,
...
template <typename Float>
inline SERPENT_ZMIJ_CONSTEXPR20 auto to_decimal(uint64_t bin_sig,
...
inline SERPENT_ZMIJ_CONSTEXPR20 auto copy_n(char* out, const char* in,
...
template <typename Float>
inline SERPENT_ZMIJ_CONSTEXPR20 auto write_constexpr(char* out, Float value) noexcept
    -> char* {
...
inline SERPENT_ZMIJ_CONSTEXPR20 auto copy_clamped(char* out, size_t n,
                                         const char* buffer,
...
inline SERPENT_ZMIJ_CONSTEXPR20 auto write(char* out, size_t n, double value) noexcept
    -> char* {
...
inline SERPENT_ZMIJ_CONSTEXPR20 auto write(char* out, size_t n, float value) noexcept
    -> char* {
  if (detail::is_constant_evaluated()) {
