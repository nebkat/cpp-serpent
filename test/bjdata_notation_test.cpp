...
void documented() {
    ...
    notated("7b5503666f6f5501550362617255027d",
            "[{][U][3][foo][U][1][U][3][bar][U][2][}]", "{foo:1,bar:2}");
}
...
void containers() {
    ...
    notated("5b2455235b550255035d010203040506",
            "[[][$][U][#][[][U][2][U][3][]][1][2][3][4][5][6]", "dimension array count");
    notated("5b2455235b5b550255035d5d010203040506",
            "[[][$][U][#][[][[][U][2][U][3][]][]][1][2][3][4][5][6]", "column-major dimension array");
    notated("5b2455235b24552355020203010203040506",
            "[[][$][U][#][[][$][U][#][U][2][2][3][1][2][3][4][5][6]", "optimized dimension array");
