...
// (include/glaze/util/itoa_40kb.hpp) by tools/vendor-glaze.sh. Do not edit: change the script and run
...
#include <serpent/external/glaze/inline.hpp>
#include <serpent/external/glaze/itoa.hpp> // For shared char_table and digit_pairs

namespace serpent::external::glaze
{
   namespace itoa_40kb_impl
   {
      ...
      SERPENT_GLZ_ALWAYS_INLINE uint64_t div_1e8(uint64_t value) noexcept
      {
...
#else
      SERPENT_GLZ_ALWAYS_INLINE uint64_t div_1e8(uint64_t value) noexcept { return value / 100000000ULL; }
#endif

      // ==================== uint32_t implementations ====================

      SERPENT_GLZ_ALWAYS_INLINE char* u32_2(char* buf, uint32_t val) noexcept
      {
      ...
      SERPENT_GLZ_ALWAYS_INLINE char* u32_4(char* buf, uint32_t val) noexcept
      {
      ...
      SERPENT_GLZ_ALWAYS_INLINE char* u32_6(char* buf, uint32_t val) noexcept
      {
      ...
      SERPENT_GLZ_ALWAYS_INLINE char* u32_8(char* buf, uint32_t val) noexcept
      {
      ...
      SERPENT_GLZ_ALWAYS_INLINE char* u32_10(char* buf, uint32_t val) noexcept
      {
      ...
      SERPENT_GLZ_ALWAYS_INLINE char* u64_2(char* buf, uint64_t val) noexcept
      {
         const uint64_t lz = val < 10;
         std::memcpy(buf, char_table + ((val * 2) | lz), 2);
         return buf + 2 - lz;
      ...
      SERPENT_GLZ_ALWAYS_INLINE char* u64_4(char* buf, uint64_t val) noexcept
      {
      ...
      SERPENT_GLZ_ALWAYS_INLINE char* u64_6(char* buf, uint64_t val) noexcept
      {
      ...
      SERPENT_GLZ_ALWAYS_INLINE char* u64_8(char* buf, uint64_t val) noexcept
      {
      ...
      SERPENT_GLZ_ALWAYS_INLINE char* u64_10(char* buf, uint64_t val) noexcept
      {
         const uint64_t high = div_1e8(val);
         const uint64_t low = val - high * 100000000;
         const uint64_t lz = high < 10;
      ...
      SERPENT_GLZ_ALWAYS_INLINE char* u64_12(char* buf, uint64_t val) noexcept
      {
         const uint64_t high = div_1e8(val);
         const uint64_t low = val - high * 100000000;
      ...
      SERPENT_GLZ_ALWAYS_INLINE char* u64_14(char* buf, uint64_t val) noexcept
      {
         const uint64_t high = div_1e8(val);
         const uint64_t low = val - high * 100000000;
      ...
      SERPENT_GLZ_ALWAYS_INLINE char* u64_16(char* buf, uint64_t val) noexcept
      {
         const uint64_t high = div_1e8(val);
         const uint64_t low = val - high * 100000000;
      ...
      SERPENT_GLZ_ALWAYS_INLINE char* u64_18(char* buf, uint64_t val) noexcept
      {
         const uint64_t high = div_1e8(val);
         const uint64_t low = val - high * 100000000;
      ...
      SERPENT_GLZ_ALWAYS_INLINE char* u64_20(char* buf, uint64_t val) noexcept
      {
         const uint64_t high = div_1e8(val);
         const uint64_t low = val - high * 100000000;
   ...
   SERPENT_GLZ_ALWAYS_INLINE char* to_chars_40kb(char* buf, T val) noexcept
   {
